...
import {
  athleteScoringProvider,
  platformEnum,
  reportStateEnum,
} from "./enums";

/** Live/Node-parity athlete_platform_links (no Nest-only columns). */
export const athletePlatformLinks = pgTable(
  "athlete_platform_links",
  {
    ...
    provider: athleteScoringProvider("provider").notNull().default("hyperauditor"),

    platform: platformEnum("platform").notNull(),

    providerSocialId: varchar("provider_social_id", {
      length: 255,
    }),
